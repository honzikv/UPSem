...
GamePreparation::GamePreparation(int playersAtGamePrep) : playersAtGamePrep(playersAtGamePrep) {
...
const int GamePreparation::getPlayersAtGamePrep() const {
    return playersAtGamePrep;
}
